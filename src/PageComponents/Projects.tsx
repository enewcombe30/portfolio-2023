...
export default function Projects() {
  function renderProjects() {
    const projects = myProjects.projects.map((project, index) => {
      return (
        <>
          <div className="w-fit mx-auto no-scrollbar">
  ...
  return (
    <>
      <div className="my-[1.5rem] pb-[5rem] w-full h-full overflow-y-scroll no-scrollbar">
        <div className="w-content mx-auto flex-wrap flex w-full">
          {renderProjects()}
        </div>
      </div>
    </>
